...
import com.akb.moviemu.adapter.MovieCastListAdapter;
import com.akb.moviemu.adapter.MovieVideoListAdapter;
...
import com.akb.moviemu.model.detail.MovieDetailCastResult;
import com.akb.moviemu.model.detail.MovieDetailCastRoot;
import com.akb.moviemu.model.detail.MovieDetailRoot;
import com.akb.moviemu.model.detail.MovieDetailVideoResult;
...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* Metode Membaca dan Menyesuaikan Data Masuk */
        /* Bundle Mulai */
        ...
        // Bilah alat pendukung untuk versi yang lebih lama
        setSupportActionBar(toolbar);
        // Nilai untuk dimasukkan dalam bilah alat
        collapsingToolbarLayout.setTitle("Suicide Squad");
        // Pengaturan status transparan dan interaksi
        statusBarSettings();
    ...
    /* Statusbar fungsi penyesuaian (Transparent)*/
    ...
    /* DetailActivity Fungsi yang menyediakan pemuatan elemen tampilan di dalam */
